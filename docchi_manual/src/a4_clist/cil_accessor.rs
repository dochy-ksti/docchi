...
impl ClistCItem {
	...
	pub fn inner_list(&self) -> CListConst<InnerListCItem>{
		CListConst::new(citem::get_cil(self.ptr, "inner_list").unwrap(), self)
	}
	
}
#[derive(Debug, PartialEq, Clone, Copy)]
pub struct InnerListCItem {
	ptr : CItemPtr,
}
impl From<CItemPtr> for InnerListCItem {
	fn from(ptr : CItemPtr) -> Self { Self{ ptr } }
}
impl InnerListCItem {
